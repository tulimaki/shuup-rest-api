...
from shuup_rest_api.serializers import LabelSerializer
from shuup_rest_api.views.address import AddressSerializer
from shuup_rest_api.views.orders import (
    OrderFilter, OrderTaxesMixin, PaymentSerializer
)
from shuup_rest_api.views.service import (
    PaymentMethodSerializer, ShippingMethodSerializer
)
from shuup_rest_api.views.shop import CurrencySerializer
